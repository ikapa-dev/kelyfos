	...
	return []EventType{
		...
		{Type: TypeCommandStart, Source: SourceHost,
			...
			Fields: []Field{
				...
				{Name: "via", Type: "string", Doc: "exec or mcp — which interface asked"},
				agentField(),
			}},
		...
		{Type: TypeTeamMessage, Source: SourceHost,
			...
			Fields: []Field{
				...
				{Name: "outcome", Type: "string", Doc: "delivered, unreachable or timeout"},
				...
				{Name: "data", Type: "string", Doc: "base64 body", When: "record_payloads = true"},
			}},
		{Type: TypeTeamRefused, Source: SourceHost,
			...
			Fields: []Field{
				{Name: "agent", Type: "string", Doc: "the sender"},
				{Name: "peer", Type: "string", Doc: "the addressee it was not allowed to reach"},
				{Name: "kind", Type: "string", Doc: "send, ask or reply"},
