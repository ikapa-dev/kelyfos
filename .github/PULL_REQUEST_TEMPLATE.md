...
1. The non-goals in the README are hard boundaries: no orchestrator, no control
...
- [ ] A change of approach, library or scope: recorded in `docs/decisions.md`, the decision
